...
const buttons = [
  { id: "All", class:"btn btn-outline-dark btn-item", text: "All" },
  { id: "Korea", class:"btn btn-outline-dark btn-item", text: "Korea" },
  { id: "Japan", class:"btn btn-outline-dark btn-item", text: "Japan" },
  { id: "China", class:"btn btn-outline-dark btn-item", text: "China" }
];

const buttonItems = buttons
.map((button) => `<button id="${button.id}" class="${button.class}" >${button.text}</button>`)
.join("");

buttonContainer.innerHTML = buttonItems;
